        ...
        if (null != csvDecryptedFiles && csvDecryptedFiles.length > 0) {
            ...
            if (whatif) {
                ...
                if (null == encryptionPassword.get()) {
                    System.out.printf("%nEncryption could not be done, there was an error reading encryption password from file");
                } else {
                    ...
                    Stream.of(csvDecryptedFiles).forEach(file -> {
                        ...
                        if (null != elements) {
                            ...
                            try {
                                ...
                                CsvCryptoUtils.encryptToCsvFile(elements, encryptionPassword.get().toCharArray(), csvEncryptedFile);
